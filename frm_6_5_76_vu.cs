...
{
    public partial class frm_6_5_76_vu : Form
    {
        // ==========================================
     ...
     Snake_76_vu[0].Y_76_vu > maxChieuRong_76_vu)
        ...
        public void ReStartGame_76_vu()
        {
            ...
            ViTri_76_vu head_76_vu = new ViTri_76_vu { X_76_vu = 10, Y_76_vu = 10 };
            ...
            for (int i_76_vu = 1; i_76_vu <= 3; i_76_vu++)
            {
            ...
            {
                X_76_vu = rand_76_vu.Next(3, maxChieuDai_76_vu - 3),
                Y_76_vu = rand_76_vu.Next(3, maxChieuRong_76_vu - 3)
            };
